          ...
          <Card className="max-w-3xl mx-auto">
            <CardHeader>
              <CardTitle className="flex items-center text-green-600">
                <Check className="mr-2" /> Device Registered Successfully!
              </CardTitle>
              <CardDescription>
                On-chain tx: <code>{result.txSignature}</code>
                <br />
                <span className="text-green-600 font-medium">
                  🎉 You've earned 50 SENSOR tokens as a reward!
                </span>
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <h4 className="font-medium text-green-800 mb-2">Reward Earned!</h4>
                <p className="text-sm text-green-700">
                  Your SENSOR token reward has been automatically minted to your wallet. 
                  Check the navbar to see your updated balance with the animated notification!
                </p>
              </div>
              <div>
                <h4 className="font-medium">Certificate PEM</h4>
                <pre className="p-4 bg-gray-100 rounded overflow-auto text-sm font-mono whitespace-pre-wrap max-h-40">
                  <code>{result.certificatePem}</code>
                </pre>
              </div>
              <div>
                <h4 className="font-medium">MQTT Broker URL</h4>
                <p className="font-mono text-sm">{result.brokerUrl}</p>
              </div>
              <div>
                <h4 className="font-medium">Device ID</h4>
                <p className="font-mono text-sm">{result.deviceId}</p>
              </div>
            </CardContent>
            <CardFooter>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <h4 className="font-medium text-blue-800 mb-2">Reward Information</h4>
                  <p className="text-sm text-blue-700">
                    Upon successful registration, you'll earn <strong>50 SENSOR tokens</strong> as a reward! 
                    This will be automatically minted to your connected wallet.
                  </p>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
