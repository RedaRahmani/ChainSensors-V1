...
export default function PurchasesClient() {
  ...
  const handleRatingSubmit = async (rating: number, comment: string) => {
    ...
    try {
      ...
      setUserReviews((prev) => ({
        ...prev,
        [purchaseToRate.id]: { rating, comment },
      }));
    } catch (err) {
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {selectedPurchase.price} usdc/{selectedPurchase.unit}
                        </p>
                      </div>
                      <div>
                    ...
                    {userReviews[selectedPurchase.id] && (
                      <div className="p-4 bg-muted rounded-lg">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <RatingDisplay
                            rating={userReviews[selectedPurchase.id].rating}
                            size="md"
                          />
                        </div>
                        <p className="text-sm text-muted-foreground">
                          {userReviews[selectedPurchase.id].comment}
                        </p>
                      </div>
                    )}
                        ...
                        <div className="p-4 bg-muted rounded-lg">
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-medium">{selectedPurchase.price} usdc</p>
                            </div>
                            <div>
