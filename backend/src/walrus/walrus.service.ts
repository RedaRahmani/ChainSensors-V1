...
//     const str = String(id);
//     if (str.length > 128) {
//       // If your Walrus returns very long CIDs, consider mapping off-chain.
//       throw new Error('Walrus blob id exceeds 128 chars; enable short ids or map off-chain');
//   }
//     return str;
//   }
...
export class WalrusService {
  ...
  // simple alias for clarity in other services
  async putCapsule(bytes: Buffer): Promise<string> {
